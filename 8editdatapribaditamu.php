<?php
 ...
 if(isset($_POST["submit"]))
 {
     if($_POST["submit"]=="Edit")
     {
        ...
        // $status_pelangan=$data["STATUS_PELANGAN"];
      ...
      {    
        ...
        $query="UPDATE pelanggan SET ID_PELANGGAN='$id_pelanggan',NAMA_PELANGGAN='$nama_pelanggan',NO_IDENTITAS='$no_identitas',NAMA_INSTITUSI='$nama_institusi',NO_TELEPON='$no_telepon',ALAMAT_PELANGGAN='$alamat_pelanggan',EMAIL_PELANGGAN='$email_pelanggan',USERNAME_PEL='$username_pel',PASSWORD_PEL='$password_pel' WHERE ID_PELANGGAN='$id_pelanggan'";
        $result=mysqli_query($link,$query);       
        ...
        if($result) {          
            header("Location:8detaildatatamu.php");
          } 
