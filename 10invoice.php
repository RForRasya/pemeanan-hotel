...
if (isset($_GET["submit"])) {     
    ...
    $query="SELECT JENIS_KAMAR,CABANG,TARIF,COUNT(DISTINCT ID_KAMAR) AS JUMLAH from kamar JOIN cabang USING(ID_CABANG)
    ...
    $dewasa="";
    $anak=""; 
    $tglcheckin=date('d/m/Y');
    $tglcheckout=date('d/m/Y');
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-xs-6">
          ...
          <p class="lead">Kartu Kredit</p>
          <p class="lead">Transfer Atm</p>
