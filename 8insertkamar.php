...
if(isset($_POST["submit"]))
{
        ...
        {
            $pesan_error="id_kamar belum terisi";
        }
        if($pesan_error==="")
        {
            ...
            $query="INSERT INTO `kamar` (`ID_KAMAR`, `ID_JENIS_KAMAR`, `ID_TEMPAT_TIDUR`, `ID_CABANG`, `NO_KAMAR`, `LANTAI`, `BEBAS_ROKOK`, `STATUS_KAMAR`)  VALUES('$id_kamar','$id_jenis_kamar','$id_tempat_tidur','$id_cabang','$no_kamar','$lantai','$bebas_rokok','$status_kamar')";
  ...
  <div class="content-wrapper">
    ...
    <div class="register-box">
      ...
      <div class="register-box-body">
        ...
        <form action="8insertkamar.php" method="post">
