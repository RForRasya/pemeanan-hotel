...
//  MariaDB [sigah2]> select year(TGL_PEMBAYARAN) AS TGL,CABANG,NOMOR_NOTA,sum(TOTAL_AKHIR) AS TOTAL from pembayaran join reservasi using(ID_RESERVASI) join CABANG USING(ID_CABANG) where CABANG LIKE "Yogyakarta" group by TGL;
  ...
  $query5  = "SELECT count(id_pelanggan) AS JUMLAH FROM pelanggan WHERE month(TGL_RESERVASI_PERTAMA) = 1 ";
  $query6  = "SELECT count(id_pelanggan) AS JUMLAH FROM pelanggan WHERE month(TGL_RESERVASI_PERTAMA) = 2 ";
  $query7  = "SELECT count(id_pelanggan) AS JUMLAH FROM pelanggan WHERE month(TGL_RESERVASI_PERTAMA) = 3 ";
  $query8  = "SELECT count(id_pelanggan) AS JUMLAH FROM pelanggan WHERE month(TGL_RESERVASI_PERTAMA) = 4 ";

  $query9  = "SELECT count(id_pelanggan) AS JUMLAH FROM pelanggan WHERE month(TGL_RESERVASI_PERTAMA) = 5 ";
  $query10 = "SELECT count(id_pelanggan) AS JUMLAH FROM pelanggan WHERE month(TGL_RESERVASI_PERTAMA) = 6 ";
  $query11 = "SELECT count(id_pelanggan) AS JUMLAH FROM pelanggan WHERE month(TGL_RESERVASI_PERTAMA) = 7 ";
  $query12 = "SELECT count(id_pelanggan) AS JUMLAH FROM pelanggan WHERE month(TGL_RESERVASI_PERTAMA) = 8 ";

  $query13 = "SELECT count(id_pelanggan) AS JUMLAH FROM pelanggan WHERE month(TGL_RESERVASI_PERTAMA) = 9 ";
  $query14 = "SELECT count(id_pelanggan) AS JUMLAH FROM pelanggan WHERE month(TGL_RESERVASI_PERTAMA) = 10 ";
  $query15 = "SELECT count(id_pelanggan) AS JUMLAH FROM pelanggan WHERE month(TGL_RESERVASI_PERTAMA) = 11 ";
  $query16 = "SELECT count(id_pelanggan) AS JUMLAH FROM pelanggan WHERE month(TGL_RESERVASI_PERTAMA) = 12 ";
...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Tampil Laporan Customer Baru
      </h1>
      <ol class="breadcrumb">        
        <li><a href="#">Home</a></li>
        <li class="active">Tampil Laporan Customer Baru</li>
      </ol>
    </section>
    <!-- //table -->
        ...
        <div class="box">
            <div class="box-header">
              <h3 class="box-title">Data Total Customer Baru Dalam Table</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              ...
              <div class="row"><div class="col-sm-6"><div class="dataTables_length" id="example1_length">
				...
				JUMLAH</th><th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending" style="width: 156px;">				
...
<script>
 $(function () {
     ...
     * ---------
     */
    var a5="<?php Print($_JML5); ?>";
    var a6="<?php Print($_JML6); ?>";
    var a7="<?php Print($_JML7); ?>";
    var a8="<?php Print($_JML8); ?>";
    var a9="<?php Print($_JML9); ?>";
    var a10="<?php Print($_JML10); ?>";
    var a11="<?php Print($_JML11); ?>";
    var a12="<?php Print($_JML12); ?>";
    var a13="<?php Print($_JML13); ?>";
    var a14="<?php Print($_JML14); ?>";
    var a15="<?php Print($_JML15); ?>";
    var a16="<?php Print($_JML16); ?>";
    var bar_data = {
