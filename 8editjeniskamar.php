<?php
 ...
 if(isset($_POST["submit"]))
 {
     if($_POST["submit"]=="Edit")
     {
        ...
        $deskripsi_kamar=$data["DESKRIPSI_JKAMAR"];
      ...
      {    
        ...
        $query="UPDATE jenis_kamar SET ID_JENIS_KAMAR='$id_jenis_kamar',JENIS_KAMAR='$jenis_kamar',KODE_JENIS_KAMAR='$kode_jenis_kamar',KAPASITAS='$kapasitas',DESKRIPSI_JKAMAR='$deskripsi_kamar' WHERE ID_JENIS_KAMAR='$id_jenis_kamar'";
        $result=mysqli_query($link,$query);       
...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
      Edit Data Jenis Kamar
      </h1>
      <ol class="breadcrumb">        
        <li><a href="#">Home</a></li>
        <li class="active">Edit Data Jenis Kamar</li>
      </ol>
    </section>
