...
if(isset($_POST["submit"]))
{
    ...
    $telepon_cabang=htmlentities(strip_tags(trim($_POST["telepon_cabang"])));      
        ...
        if($pesan_error==="")
        {
            ...
            $query="INSERT INTO cabang VALUES('$id_cabang','$cabang','$alamat_cabang','$telepon_cabang')";
...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">        
        <li><a href="#">Home</a></li>
        <li class="active">Cretae Lokasi Cabang hotel</li>
      </ol>
    </section>
    ...
    <div class="register-box">
      ...
      <div class="register-box-body">
        ...
        <form action="8createlokasi.php" method="post">
